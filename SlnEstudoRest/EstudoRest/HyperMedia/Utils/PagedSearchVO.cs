...
namespace EstudoRest.HyperMedia.Utils
{
    public class PagedSearchVO<T> where T : ISupportsHyperMedia
    {
        ...
        public PagedSearchVO(int currentPage, string sortFields, string sortDirection) : this(currentPage, 10, sortFields, sortDirection)
        {
